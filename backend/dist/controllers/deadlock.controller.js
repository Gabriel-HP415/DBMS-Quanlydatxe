...
exports.getDeadlockInfo = getDeadlockInfo;
exports.runDeadlock = runDeadlock;
const deadlock_service_1 = require("../services/deadlock.service");
const service = new deadlock_service_1.DeadlockService();
/** GET /deadlock/info - Thông tin ghế A1/A2 cho demo */
async function getDeadlockInfo(req, res, next) {
    try {
...
async function runDeadlock(req, res, next) {
    try {
